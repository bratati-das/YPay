...
export default class FundBalance extends Component {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Image
            ...
            />
            <Text style={styles.itemHLT}>Fund Balance</Text>
          </View>
          {/* itemR */}
        ...
        <ScrollView style={styles.body}>
          ...
          <View style={styles.topSec}>
            ...
            <Text style={styles.h2}>₹ 2000</Text>
          </View>
          {/* section */}
          {/* row */}
          {/* list container */}
          <TouchableOpacity style={styles.listC}>
            ...
            <View style={styles.listI}>
              <Image style={styles.icon} source={require('../img/icon/addMoney.png')} />
            </View>
            {/* list name */}
            <View style={styles.listTB}>
              <Text style={styles.listT}>Add Money</Text>
          ...
          <TouchableOpacity style={styles.listC}>
            {/* list icon */}
            <View style={styles.listI}>
              <Image style={styles.icon} source={require('../img/icon/bankTrans.png')} />
            </View>
            {/* list name */}
            <View style={styles.listTB}>
              <Text style={styles.listT}>Send Money to Bank</Text>
              <Image style={styles.listA} source={require('../img/icon/angle.png')} />
            </View>
          </TouchableOpacity>
          {/* row */}
          ...
          <TouchableOpacity style={styles.listC}>
            ...
            {/* list name */}
            <View style={styles.listTB}>
              <Text style={styles.listT}>Account Statement</Text>
              <Image style={styles.listA} source={require('../img/icon/angle.png')} />
            </View>
          </TouchableOpacity>
        </ScrollView>
