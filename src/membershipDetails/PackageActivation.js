...
export default class PackageActive extends Component {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.itemHL}>
            ...
            />
            <Text style={styles.itemHLT}>Package Activation</Text>
          </View>
          {/* itemR */}
          ...
          <View style={styles.body}>
            ...
            <View style={styles.secR}>
              <View style={styles.secCL}>
                <Image
                  style={styles.icon}
                  source={require('../img/icon/status.png')}
                />
                <Text style={styles.h1}>Action</Text>
              </View>
              <View style={styles.secCR}>              
                <Text style={styles.h3}>Already Active</Text>                
              </View>
            </View>
          </View>
        </ScrollView>
